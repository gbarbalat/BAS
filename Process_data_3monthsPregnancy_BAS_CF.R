...
create_db_policy_3monthsPregnancy <- function(id, Exp, POLICY, p90, p95) {
# header ----
...
## split preN postN intro 3 periods ----
#/*
...
#/*
return(cbind(df_preN1,df_preN2,df_preN3,df_postN1,df_postN2,df_postN3))
#*/
}